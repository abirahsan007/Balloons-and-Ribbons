                ...
                <tbody>
                    ...
                    try{
                        ...
                        $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                    ...
                                    $s = "SELECT customer_id,name from customers where cus_username = '$un'";
                                    $ret = $con->query($s);
                                    $rs = $ret->fetchAll(PDO::FETCH_NUM);
                                    $cus_id = $rs[0][0];
                                    $cus_name = $rs[0][1];
                                    //echo "$cus_id";
                                    $stmt="SELECT * FROM venue_booking where customer_id = '$cus_id'";
