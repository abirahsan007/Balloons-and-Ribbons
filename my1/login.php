...
<body>
    ...
    <!-- Header End -->
    <!-- Hero Section Begin -->
    <div class="hero-section set-bg" data-setbg="img/events-16.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-text">
        ...
        <div class="container">
          ...
          <div align="center">
            <div class="row">
              ...
              <div class="col-lg-12">
                  <form action="validitytest.php" method="post" class="contact-form">
                      <div class="row">
                        <div class="col-lg-12">
                            <input type="text" id="uname" type="text" name="uname" placeholder="Username">
                        </div>
                         ...
                         <div class="col-lg-12">
                          <input type="submit" class="submit-btn contact-btn" value="Login">
                        </div>
