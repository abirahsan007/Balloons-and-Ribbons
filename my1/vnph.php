  ...
  <tbody>
    <?php
       ...
       try{
           ...
           $stmt="SELECT vr.id, vr.venue_id, vn.name, vr.customer_id, cus.name, vr.amount
           FROM venues as vn,customers as cus, payment_history as vr  
           WHERE vr.customer_id = cus.customer_id and vr.venue_id = vn.venue_id and cus.customer_id='$id' ORDER BY vr.id DESC";
