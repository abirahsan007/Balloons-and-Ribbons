...
<body>
                    ...
                    <div class="col-lg-10 col-md-10">
                        <nav class="main-menu mobile-menu">
                            <ul>
                                ...
                                <li><a class="active" href="./venues_ad.php">Venues</a></li>
    ...
    <div class="classes-time-section spad set-bg" data-setbg="img/events-14.jpg">
        <div class="container">
            <div class="row">
  ...
  <tbody>
    <?php
           ...
           try{
               ...
               if(isset($vnname)){
                   $stmt="SELECT v.name,v.type,v.location,v.hourly_cost,v.dimensions,v.availability,v.max_capacity,v.venue_schedule,v.contact
                           FROM venues as v
                           where v.name is not null and v.name like \"%$vnname%\" ";
