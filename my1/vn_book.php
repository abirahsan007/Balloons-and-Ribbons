                    ...
                    <div class="col-lg-10 col-md-10">
                        <nav class="main-menu mobile-menu">
                            <ul class="srch">
                                ...
                                <li><a class="active" href="vn_book.php">Venue Booking</a></li>
        ...
        <div class="container">
          <div align="center">
            <div class="row">
              ...
              <form method="post" action="vn_req.php">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Guest Capacity</label>
                <div class="col-sm-6">
