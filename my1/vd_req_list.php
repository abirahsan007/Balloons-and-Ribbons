    ...
    <?php
       ...
       try{
           ...
           $stmt="SELECT vr.request_id, vr.vendor_id, vd.brand_name, vr.customer_id, cus.name, vr.booking_date, vr.event_date, vr.event_type, vr.Event_location, vr.duration, vr.event_schedule
                ...
                WHERE vr.customer_id = cus.customer_id and vr.vendor_id = vd.vendor_id and cus.customer_id='$id'";
           ...
           foreach($table as $row){
              echo "<tr> <td>"
                  ...
                  . $row[9]. "</td><td>"
                  . $row[10]. "</td><td>" 
                  ?><a class="btn btn-primary btn-block" href="delreq22.php?id=<?php echo $row[0] ?>&id1=<?php echo $row[1] ?>&id2=<?php echo $row[3] ?>">Cancel request</a><?php "</td></tr>" ;
