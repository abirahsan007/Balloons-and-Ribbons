        ...
        <div class="container">
          <div align="center">
            <div class="row">
              ...
              <form method="post" action="addvn1.php">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Cost per Hour</label>
                <div class="col-sm-6">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Dimention</label>
                <div class="col-sm-6">
                  <input type="text" id="dm" name="dm" class="form-control"  >
                </div>
              </div>
              ...
              <div class="form-group row">
                <label  class="col-sm-2 col-form-label">Venue Schedule</label>
                <div class="col-sm-6">
