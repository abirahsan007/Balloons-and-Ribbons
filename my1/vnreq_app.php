    ...
    <?php
       ...
       try{
           ...
           $stmt="SELECT vr.request_id, vr.venue_id, vn.name, vr.customer_id, cus.name, vr.booking_date, vr.event_date, vr.event_type, vr.guest_capacity, vr.duration, vr.event_schedule
                  ...
                  WHERE vr.customer_id = cus.customer_id and vr.venue_id = vn.venue_id
                  ORDER BY vr.event_date";
           ...
           foreach($table as $row){
              echo "<tr> <td>"
                  ...
                  . $row[9]. "</td><td>"
                  . $row[10]. "</td><td>"
                  ?><a class="btn btn-primary btn-block" href="delvnr.php?id=<?php echo $row[0] ?>&id1=<?php echo $row[1] ?>&id2=<?php echo $row[2] ?>&id3=<?php echo $row[3] ?>&id4=<?php echo $row[4] ?>&id5=<?php echo $row[5] ?>&id6=<?php echo $row[6] ?>&id7=<?php echo $row[7] ?>&id8=<?php echo $row[8] ?>&id9=<?php echo $row[9] ?>&id10=<?php echo $row[10] ?>">select</a><?php "</td></tr>" ;
