        ...
        <div class="container">
          <div align="center">
            <div class="row">
              ...
              <form method="post" action="vnpay.php">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" id="amnt"  name="amnt" class="form-control" >
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Card no.</label>
                <div class="col-sm-6">
                  <input type="text" id="crd"  name="crd" class="form-control" >
                </div>
              </div>
