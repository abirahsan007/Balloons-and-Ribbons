...
<body>
        ...
        <div class="container">
          <div align="center">
            <div class="row">
              ...
              <form method="post" action="sch1_vd-ad.php">
              
    <div class="form-group row">
      <label for="inputEmail3" class="col-sm-2 col-form-label">Vendor Type</label>
      <div class="col-sm-6">
        <select id="inputState" name="vdt" class="form-control">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <select id="inputState" name="loc1" class="form-control">
          <option selected>Any</option>
    ...
    <div class="form-group row">
      <label  class="col-sm-2 col-form-label">Maximum Budget</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <select id="inputState" name="sch1" class="form-control">
        <option selected>Any</option>
                    <option>day</option>
    ...
    <div class="form-group row">
      <div class="col-sm-10">
        <button type="submit" name="cnt1" class="btn btn-primary">Continue</button>
      </div>
    </div>
  </form>
            </div>
